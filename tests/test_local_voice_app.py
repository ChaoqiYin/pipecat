...
@pytest.mark.parametrize(
    ...
    [
        (
            {"STT_PROVIDER": "secret-invalid-provider"},
            "STT_PROVIDER must be elevenlabs or volcengine",
        ),
        ({}, "ELEVENLABS_API_KEY"),
        ({"ELEVENLABS_API_KEY": "  "}, "ELEVENLABS_API_KEY"),
        ({"STT_PROVIDER": "volcengine"}, "VOLCENGINE_API_KEY"),
        (
            {"STT_PROVIDER": "volcengine", "VOLCENGINE_API_KEY": "  "},
            "VOLCENGINE_API_KEY",
        ),
...
async def test_volcengine_session_still_requires_elevenlabs_tts_key(monkeypatch):
    monkeypatch.setenv("STT_PROVIDER", "volcengine")
    monkeypatch.setenv("VOLCENGINE_API_KEY", "volc-test-key")
